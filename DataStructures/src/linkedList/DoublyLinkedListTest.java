...
class DoublyLinkedListTest {
	...
	void testAddNull() {
		...
		String expectedMessage = "Cannot add nulls to the Doubly Linked List";
	...
	void testAddObjects() {
		...
		assertEquals(false, list.isEmpty());
		assertEquals("a", list.get(0));
		assertEquals(null, list.getNode(0).getPrev());
		...
		assertEquals("a", list.getNode(1).getPrev().getData());
		...
		assertEquals("b", list.getNode(2).getPrev().getData());
	...
	void testRemoveAddRemove() {
		...
		assertEquals("a", list.get(list.size()-1));
		assertEquals(null, list.getNode(0).getPrev());
		assertEquals(null, list.getNode(list.size()-1).getNext());
		...
		assertEquals("a", list.get(list.size()-1));
		assertEquals(null, list.getNode(0).getPrev());
		assertEquals("a", list.getNode(0).getNext().getData());
		assertEquals("b", list.getNode(1).getPrev().getData());
		assertEquals(null, list.getNode(list.size()-1).getNext());
		...
		assertEquals(null, list.getNode(0).getPrev());
		assertEquals("b", list.getNode(0).getNext().getData());
		assertEquals("c", list.getNode(1).getPrev().getData());
		assertEquals("a", list.getNode(1).getNext().getData());
		assertEquals("b", list.getNode(2).getPrev().getData());
		assertEquals(null, list.getNode(list.size()-1).getNext());
		...
		assertEquals("a", list.getNode(1).getNext().getData());
		assertEquals("b", list.getNode(2).getPrev().getData());
		assertEquals("b", list.getNode(2).getNext().getData());
		assertEquals("a", list.getNode(3).getPrev().getData());
		assertEquals(null, list.getNode(list.size()-1).getNext());
		...
		assertEquals("b", list.getNode(2).getNext().getData());
		assertEquals("a", list.getNode(3).getPrev().getData());
		assertEquals("c", list.getNode(3).getNext().getData());
		assertEquals("b", list.getNode(4).getPrev().getData());
		assertEquals(null, list.getNode(list.size()-1).getNext());
